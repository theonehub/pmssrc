...
class PayoutController:
    ...
    async def create_payout(
        ...
        try:
            ...
            from app.domain.entities.taxation.payout import PayoutCreate
    ...
    async def update_payout(
        ...
        try:
            ...
            # Convert request to domain model
            from app.domain.entities.taxation.payout import PayoutUpdate
    ...
    async def update_payout_status(
        ...
        try:
            ...
            # Call the service layer
            from app.domain.entities.taxation.payout import PayoutStatus
    ...
    async def bulk_process_payouts(
        ...
        try:
            ...
            # Convert request to domain model
            from app.domain.entities.taxation.payout import BulkPayoutRequest
