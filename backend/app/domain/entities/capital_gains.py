...
class CapitalGainsIncome:
    ...
    def get_tax_computation_details(self) -> Dict[str, Any]:
        """
        Get detailed tax computation for capital gains.
        
        Returns:
            Dict: Tax computation details
        """
        return {
            "computation_notes": {
                "stcg_111a": "Equity with STT - Taxed at 20% (Budget 2024)",
                "stcg_other": "Other assets - Added to regular income and taxed at slab rates",
                "ltcg_112a": "Equity with STT - Taxed at 12.5% after ₹1.25L exemption (Budget 2024)",
                "ltcg_other": "Other assets including debt MF - Taxed at 12.5% (Budget 2024)"
            },
            "tax_rates": {
                "stcg_111a_rate": "20%",
                "ltcg_112a_rate": "12.5%",
                "ltcg_other_rate": "12.5%",
                "ltcg_112a_exemption": "₹1,25,000"
            },
            "budget_2024_changes": [
                "STCG 111A rate increased from 15% to 20%",
                "LTCG 112A rate increased from 10% to 12.5%",
                "LTCG 112A exemption increased from ₹1L to ₹1.25L",
                "LTCG from other assets rate changed to 12.5%"
            ]
        } 