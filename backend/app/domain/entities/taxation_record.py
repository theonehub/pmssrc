...
class TaxationRecord:
    ...
    def __post_init__(self):
        ...
        if not self.taxation_id:
            object.__setattr__(self, 'taxation_id', str(uuid4()))
    ...
    def get_comprehensive_income_breakdown(self) -> Dict[str, Any]:
        ...
        breakdown = {
            "salary_income": {
                ...
                "exemptions": self.salary_income.calculate_total_exemptions(self.regime).to_float(),
                "breakdown": self.salary_income.get_salary_breakdown(self.regime)
            }
        }
    ...
    def get_regime_switch_impact(self, calculation_service: TaxCalculationService) -> Dict[str, Any]:
        ...
        total_exemptions = self.salary_income.calculate_total_exemptions(self.regime)
