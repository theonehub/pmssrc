...
from app.api.routes.monthly_payout_routes_v2 import router as monthly_payout_routes_v2_router
...
app.include_router(monthly_payout_routes_v2_router, tags=["💰 Monthly Payouts V2 (SOLID)"])
