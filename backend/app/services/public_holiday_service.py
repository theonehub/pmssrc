...
def create_holiday(holiday: PublicHoliday, user_empId: str):
    """
    ...
    holiday_dict["created_by"] = user_empId
    
    result = public_holidays_collection.insert_one(holiday_dict)
    
    return str(result.inserted_id)

def update_holiday(holiday_id: str, holiday: PublicHoliday, user_empId: str) -> bool:
    """
...
def import_holidays_from_file(holiday_data_list: List[dict], user_empId: str) -> int:
    """
