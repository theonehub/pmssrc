...
from models.salary_history import (
...
from services.taxation_service import calculate_and_save_tax, get_taxation_by_emp_id
...
def create_salary_change(employee_id: str, salary_change: SalaryChangeRequest, approved_by: str, hostname: str) -> SalaryHistoryInDB:
    """
    ...
    try:
        ...
        # Update taxation data with new salary components
        update_taxation_for_salary_change(employee_id, salary_change, hostname)
...
def calculate_annual_salary_projection(employee_id: str, tax_year: str, hostname: str) -> SalaryProjection:
    """
    ...
    try:
        ...
        if not salary_changes_list:
            # No salary changes, get current taxation data
            try:
                taxation_data = get_taxation_by_emp_id(employee_id, hostname)
...
def update_taxation_for_salary_change(employee_id: str, salary_change: SalaryChangeRequest, hostname: str):
    """
    ...
    try:
        ...
        projection = calculate_annual_salary_projection(employee_id, tax_year, hostname)
...
def bulk_recalculate_taxes_for_salary_changes(hostname: str) -> Dict[str, int]:
    """
