...
from app.api.routes.monthly_salary_routes import router as monthly_salary_routes_router
...
app.include_router(monthly_salary_routes_router, tags=["💰 Monthly Salary Processing V2 (SOLID)"])
