      ...
      <Paper variant="outlined" sx={{ p: 3, mb: 3 }}>
        ...
        >
          <TextField
            ...
            type="text"
            value={formatIndianNumber(gratuity.gratuity_income)}
      ...
      <Paper variant="outlined" sx={{ p: 3, mb: 3 }}>
        ...
        >
          <FormControlLabel
            control={
              <Checkbox
                checked={leaveEncashment.during_employment}
                onChange={(e) => {
          ...
          <FormControlLabel
            control={
              <Checkbox
                checked={leaveEncashment.is_deceased}
          ...
          <TextField
            ...
            type="text"
            value={formatIndianNumber(leaveEncashment.leave_encashment_income_received)}
          ...
          <TextField
            ...
            type="text"
            value={formatIndianNumber(leaveEncashment.leave_encashed)}
            onChange={(e) => handleTextFieldChange('leave_encashment', 'leave_encashed', e)}
            disabled={leaveEncashment.during_employment}
      ...
      <Paper variant="outlined" sx={{ p: 3, mb: 3 }}>
        ...
        >
          <FormControlLabel
            control={
              <Checkbox
                checked={voluntaryRetirement.is_vrs_requested}
                onChange={(e) => {
                  const newStatus = e.target.checked;
          ...
          <TextField
            ...
            label="VRS Amount"
            type="text"
            value={formatIndianNumber(voluntaryRetirement.voluntary_retirement_amount)}
      ...
      <Paper variant="outlined" sx={{ p: 3, mb: 3 }}>
        ...
        >
          <FormControlLabel
            control={
              <Checkbox
                checked={retrenchmentCompensation.is_provided}
          ...
          {retrenchmentCompensation.is_provided && (
            <TextField
              ...
              type="text"
              value={formatIndianNumber(retrenchmentCompensation.retrenchment_amount)}
      ...
      <Paper variant="outlined" sx={{ p: 3 }}>
        ...
        >
          <TextField
            ...
            type="text"
            value={formatIndianNumber(pension.total_pension_income)}
          ...
          <TextField
            ...
            type="text"
            value={formatIndianNumber(pension.computed_pension_percentage)}
          ...
          <FormControl fullWidth>
            <Select
              value={pension.uncomputed_pension_frequency || 'Monthly'}
          ...
          <TextField
            ...
            type="text"
            value={formatIndianNumber(pension.uncomputed_pension_amount)}
