...
const AddNewOrganisation: React.FC = () => {
  ...
  const loadOrganisation = async (organisationId: string) => {
    try {
      ...
      const response = await axios.get(`${API_BASE_URL}/organisations/${organisationId}/`, {
      ...
      showToast(error.response?.data?.detail || 'Failed to load organisation', 'error');
    }
  };
            ...
            >
              ...
              <Box sx={{ backgroundColor: '#f1f3f4', p: 2, borderRadius: 1, fontFamily: 'monospace', fontSize: '0.875rem' }}>
                <Typography variant="body2" sx={{ fontFamily: 'inherit' }}>
                  ...
                  <strong>Issue:</strong> Line 37 expects <code>current_user: dict</code> but receives <code>CurrentUser</code> object<br/>
