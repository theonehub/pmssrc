  ...
  const loadPerquisitesDataForDialog = useCallback(async (): Promise<void> => {
    try {
      ...
      const perquisitesData: PerquisitesData = {
        ...
        // ESOP
        esop_exercise_value: data.esop?.esop_exercise_value || 0,
        esop_fair_market_value: data.esop?.esop_fair_market_value || 0,
        esop_shares_exercised: data.esop?.esop_shares_exercised || 0,
        ...
        // Lunch Refreshment
        lunch_employer_cost: data.lunch_refreshment?.lunch_employer_cost || 0,
        lunch_employee_payment: data.lunch_refreshment?.lunch_employee_payment || 0,
        lunch_meal_days_per_year: data.lunch_refreshment?.lunch_meal_days_per_year || 250,
