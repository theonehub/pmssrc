...
/**
 * TaxDeclaration Component
 * Allows users to declare their tax information
 * @returns {JSX.Element} TaxDeclaration component
 */
const TaxDeclaration = () => {
  ...
  // Modified version of handleInputChange to work with formatted numbers and handle string values
  const handleInputChange = (section, field, value) => {
    // Check if the field should be treated as a string (not converted to number)
    const stringFields = [
      'hra_city', 'relation_80dd', 'disability_percentage', 'relation_80ddb',
      'disability_percentage_80u', 'section_80g_100_head', 'section_80g_50_head',
      'section_80g_100_ql_head', 'section_80g_50_ql_head', 'ev_purchase_date',
      'accommodation_provided', 'accommodation_city_population', 'car_use', 'travel_through',
      'loan_type'
    ];
  ...
  // Modified version of handleNestedInputChange to work with formatted numbers and handle string values
  const handleNestedInputChange = (section, nestedSection, field, value) => {
    console.log(section, nestedSection, field, value);
    ...
    const stringFields = [
      ...
      'grant_date', 'vesting_date', 'exercise_date', 'movable_asset_type',
                      ...
                      <Grid container spacing={3}>
                        ...
                        <Grid item xs={12} md={6}>
                          <FormControl fullWidth>
                            ...
                            >
                              ...
                              <MenuItem value="Upto 15 lakhs">Upto 15 Lakhs</MenuItem>
                            </Select>
                        ...
                        <Grid item xs={12} md={6}>
                          <FormControlLabel
                            control={
                              <Switch
                                checked={taxationData.salary.perquisites?.is_furniture_owned || false}
                        ...
                        {/* <Grid item xs={12} md={6}>
                          <TextField
                            ...
                            label="Actual Cost"
                            type="text"
                            value={formatIndianNumber(taxationData.salary.perquisites?.furniture_actual_cost || 0)}
                          ...
                          />
                        </Grid> */}  {/* Discuss: Its not used in calculation */}
                        <Grid item xs={12} md={6}>
                          <TextField
                            fullWidth
                        ...
                        <Grid item xs={12} md={6}>
                          <FormControlLabel
                            ...
                            label="Employer Provided Driver"
                          />
                        </Grid>
                        <Grid item xs={12} md={6}>
                          {/*NextLine */}
                        ...
                        <Grid item xs={12} md={6}>
                          <Tooltip title="Monthly expenses incurred by employer for the car.">
                            <TextField
                              fullWidth
                              label="Monthly Expenses Incurred by Employer"
                              type="text"
                        ...
                        <Grid item xs={12} md={6}>
                          <Tooltip title="Months Car is Used.">
                            <TextField
                              fullWidth
                              label="Months Car is Used"
                              type="number"
                              value={formatIndianNumber(taxationData.salary.perquisites?.month_counts || 0)}
                        ...
                        <Divider sx={{ my: 4, width: '100%' }} />
                        <Grid item xs={12} md={6}>
                          <Tooltip title="Monthly expenses incurred by employer for the Other Vehicle.">
                            <TextField
                              fullWidth
                              label="Other Vehicle Monthly Expenses Incurred by Employer"
                              type="text"
                        ...
                        <Grid item xs={12} md={6}>
                          <Tooltip title="Months Other Vehicle is Used.">
                            <TextField
                              fullWidth
                              label="Months Other Vehicle is Used"
                              type="text"
                              value={formatIndianNumber(taxationData.salary.perquisites?.other_vehicle_month_counts || 0)}
                        ...
                        >
                          <Typography variant="h6" color="primary">Medical Treatment</Typography>
                        </Box>
                        ...
                        <Grid item xs={12} md={6}>
                          <Tooltip title="Travelling Allowance for Treatment">
                            <TextField
                              fullWidth
                              label="Travelling Allowance for Treatment"
                              type="text"
                        ...
                        >
                          <Typography variant="h6" color="primary">Free Education</Typography>
                        </Box>
                        <Grid item xs={12} md={6}>
                          <FormControlLabel
                            control={
                              <Checkbox 
                                checked={!!taxationData.salary.perquisites?.employer_maintained_1st_child}
                                onChange={(e) => handleNestedInputChange('salary', 'perquisites', 'employer_maintained_1st_child', e.target.checked)}
                              />
                            }
                            label="Is first child's institute maintained by employer?"
                          />
                        </Grid>
                        <Grid item xs={12} md={6}>
                          <TextField
                            fullWidth
                            label="Monthly Count (1st Child)"
                            type="text"
                            value={formatIndianNumber(taxationData.salary.perquisites?.monthly_count_1st_child || 0)}
                        ...
                        <Grid item xs={12} md={6}>
                          <TextField
                            fullWidth
                            label="Employer Monthly Expenses (1st Child)"
                            type="text"
                        ...
                        <Grid item xs={12} md={6}>
                          <FormControlLabel
                            control={
                              <Checkbox 
                                checked={!!taxationData.salary.perquisites?.employer_maintained_2nd_child}
                                onChange={(e) => handleNestedInputChange('salary', 'perquisites', 'employer_maintained_2nd_child', e.target.checked)}
                              />
                            }
                            label="Is second child's institute maintained by employer?"
                          />
                        </Grid>
                        <Grid item xs={12} md={6}>
                          <TextField
                            fullWidth
                            label="Monthly Count (2nd Child)"
                            type="text"
                            value={formatIndianNumber(taxationData.salary.perquisites?.monthly_count_2nd_child || 0)}
                        ...
                        <Grid item xs={12} md={6}>
                          <TextField
                            fullWidth
                            label="Employer Monthly Expenses (2nd Child)"
                            type="text"
                        ...
                        >
                          <Typography variant="h6" color="primary">Gas, Electricity, Water Expenses</Typography>
                        </Box>
                        ...
                        <Box sx={{ width: '100%', display: 'flex', justifyContent: 'center' }}>
                          <Typography variant="h6" color="primary">Electricity</Typography>
                        </Box>
                        ...
                        <Grid item xs={12} md={6}>
                          <TextField
                            fullWidth
                            label="Electricity Cost by Employer"
                            type="text"
                        ...
                        <Grid item xs={12} md={6}>
                          <TextField
                            fullWidth
                            label="Electricity Cost by Employee"
                            type="text"
                        ...
                        <Box sx={{ width: '100%', display: 'flex', justifyContent: 'center' }}>
                          <Typography variant="h6" color="primary">Water</Typography>
                        </Box>
                        ...
                        >
                          <Typography variant="h6" color="primary">Loans</Typography>
                        </Box>
                        <Grid item xs={12} md={6}>
                          <FormControl fullWidth>
                        ...
                        <Grid item xs={12} md={6}>
                          <TextField
                            ...
                            type="number"
                            value={taxationData.salary.perquisites?.loan_interest_rate_company || 0}
                        ...
                        >
                          <Typography variant="h6" color="primary">Leave Travel Allowance</Typography>
                        </Box>
                        <Grid item xs={12} md={6}>
                          <FormControl fullWidth>
                            ...
                            >
                              ...
                              <MenuItem value="Car">Railways</MenuItem>
                        ...
                        <Grid item xs={12} md={6}>
                          <TextField
                            fullWidth
                            label=" Claim Count with 4 year gap"
                            type="text"
                            value={formatIndianNumber(taxationData.salary.perquisites?.lta_claimed_count || 0)}
                        ...
                        <Grid item xs={12} md={6}>
                          <Tooltip title={
                            <span>
                              ...
                              If Mode is Public Transport, Actual Fair.
                           </span>
                           }>
                          <TextField
                            fullWidth
                            label="Fair Travel Cost "
                            type="text"
                        ...
                        <Grid item xs={12} md={6}>
                          <TextField
                            fullWidth
                            label="Shares Awarded"
                            type="text"
                            value={formatIndianNumber(taxationData.salary.perquisites?.number_of_esop_shares_awarded || 0)}
                        ...
                        <Grid item xs={12} md={6}>
                          <TextField
                            ...
                            type="text"
                            value={formatIndianNumber(taxationData.salary.perquisites?.vesting_period || 0)}
                            onChange={(e) => handleNestedInputChange('salary', 'perquisites', 'vesting_period', e.target.value)}
                            onFocus={(e) => handleNestedFocus('salary', 'perquisites', 'vesting_period', e.target.value)}
                          />
                        </Grid>
                        <Grid item xs={12} md={6}>
                          <TextField
                            fullWidth
                            label="Exercise Period (months)"
                            type="text"
                            value={formatIndianNumber(taxationData.salary.perquisites?.exercise_period || 0)}
                            onChange={(e) => handleNestedInputChange('salary', 'perquisites', 'exercise_period', e.target.value)}
                            onFocus={(e) => handleNestedFocus('salary', 'perquisites', 'exercise_period', e.target.value)}
                          />
                        </Grid>
                        <Grid item xs={12} md={6}>
                          <TextField
                            ...
                            label="Exercise Price per Share"
                            type="text"
                            value={formatIndianNumber(taxationData.salary.perquisites?.exercise_price_per_share || 0)}
                            onChange={(e) => handleNestedInputChange('salary', 'perquisites', 'exercise_price_per_share', e.target.value)}
                            InputProps={{ startAdornment: '₹' }}
                            onFocus={(e) => handleNestedFocus('salary', 'perquisites', 'exercise_price_per_share', e.target.value)}
                            helperText="If different from ESOP Exercise Price"
                          />
                        </Grid>

                        <Divider sx={{ my: 4, width: '100%' }} />
                        
                        {/* Movable Assets Perquisites */}
                        <Box 
                          sx={{ 
                            width: '100%', 
                            display: 'flex',
                        ...
                        >
                          <Typography variant="h6" color="primary">Movable Assets(Other than Computer)</Typography>
                        </Box>
                        <Grid item xs={12} md={6}>
                          <FormControl fullWidth>
                            <InputLabel>Usable Asset Ownership</InputLabel>
                            <Select
                              value={taxationData.salary.perquisites?.movable_asset_type || 'Electronics'}
                              label="Movable Asset Type"
                              onChange={(e) => handleNestedInputChange('salary', 'perquisites', 'movable_asset_type', e.target.value)}
                            >
                        ...
                        <Grid item xs={12} md={6}>
                          <TextField
                            ...
                            label="Cost to Employer"
                            type="text"
                            value={formatIndianNumber(taxationData.salary.perquisites?.movable_asset_value_to_employer || 0)}
                            onChange={(e) => handleNestedInputChange('salary', 'perquisites', 'movable_asset_value_to_employer', e.target.value)}
                            InputProps={{ startAdornment: '₹' }}
                            onFocus={(e) => handleNestedFocus('salary', 'perquisites', 'movable_asset_value_to_employer', e.target.value)}
                          />
                        </Grid>
                        <Grid item xs={12} md={6}>
                          <TextField
                            ...
                            type="text"
                            value={formatIndianNumber(taxationData.salary.perquisites?.movable_asset_value_to_employee || 0)}
                            onChange={(e) => handleNestedInputChange('salary', 'perquisites', 'movable_asset_value_to_employee', e.target.value)}
                            InputProps={{ startAdornment: '₹' }}
                            onFocus={(e) => handleNestedFocus('salary', 'perquisites', 'movable_asset_value_to_employee', e.target.value)}
                          />
                        </Grid>
                        <Grid item xs={12} md={6}>
                          <TextField
                            fullWidth
                            label="Completed Years of Use"
                            type="text"
                            value={formatIndianNumber(taxationData.salary.perquisites?.number_of_completed_years_of_use || 0)}
                            onChange={(e) => handleNestedInputChange('salary', 'perquisites', 'number_of_completed_years_of_use', e.target.value)}
                            onFocus={(e) => handleNestedFocus('salary', 'perquisites', 'number_of_completed_years_of_use', e.target.value)}
                          />
                        </Grid>
                        ...
                        >
                          <Typography variant="h6" color="primary">Other Benefits</Typography>
                        </Box>
                        <Box 
                          sx={{ 
                            width: '100%', 
                        ...
                        >
                          <Typography variant="h6" color="primary">Lunch</Typography>
                        </Box>
                        ...
                        >
                          <Typography variant="h6" color="primary">Gift</Typography>
                        </Box>

                        <Grid item xs={12} md={6}>
                          <TextField
                            fullWidth
                            label="Gift Vouchers Value"
                            type="text"
                        ...
                        <Grid item xs={12} md={6}>
                          <TextField
                            fullWidth
                            label="Official Purpose Contribution"
                            type="text"
